...
• 작성계획 검토, 내용구조화, 규칙 준수, 문체 변화, 구조화 방식, 작성 방식, 분석 과정, 검토 결과를 절대 쓰지 마세요
• 위 금지어와 비슷한 점검표, 계획, 체크리스트, 설명 문장도 절대 쓰지 마세요
...
다른 설명, 작성계획, 내용구조화 문구 없이 "【상담 개요】"로 바로 시작해 위 두 섹션의 최종 요약 결과만 작성해주세요:`
