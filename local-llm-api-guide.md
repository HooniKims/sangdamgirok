...
|---------|-----------|------|------------------|------------|
| `gemma4:e4b` | Gemma 4 E4B | 기본 모델, 기준 속도기준 품질 | `google/gemma-4-e4b` | `3072` |
| `gemma4:e2b` | Gemma 4 E2B | 기본보다 빠름, 품질은 간단 | `google/gemma-4-e2b` | `2048` |
| `lmstudio:gemma-4-26b-a4b-it-q4ks` | Gemma 4 26B Q4 | 느리지만 품질 높음 | `gemma-4-26b-a4b-it` | `4096` |

기본 선택 모델은 반드시 `gemma4:e4b`입니다.
